...
//namespace amgx {
//namespace classical {
//template <class Matrix, class Vector> class HMIS_Selector;
//}
//}
...
template <class T_Config> class  HMIS_Selector;

template <class T_Config>
class HMIS_SelectorBase : public Selector<T_Config>
{
...
class HMIS_Selector< TemplateConfig<AMGX_host, t_vecPrec, t_matPrec, t_indPrec> > : public HMIS_SelectorBase< TemplateConfig<AMGX_host, t_vecPrec, t_matPrec, t_indPrec> >
{
...
template <AMGX_VecPrecision t_vecPrec, AMGX_MatPrecision t_matPrec, AMGX_IndPrecision t_indPrec>
class HMIS_Selector< TemplateConfig<AMGX_device, t_vecPrec, t_matPrec, t_indPrec> >: public HMIS_SelectorBase< TemplateConfig<AMGX_device, t_vecPrec, t_matPrec, t_indPrec> >
{
