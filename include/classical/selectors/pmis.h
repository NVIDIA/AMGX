...
//namespace amgx {
//namespace classical {
//template <class Matrix, class Vector> class PMIS_Selector;
//}
//}
...
template <class T_Config> class  PMIS_Selector;

template <class T_Config>
class PMIS_SelectorBase : public Selector<T_Config>
{
    ...
    public:
        ...
        PMIS_SelectorBase(AMG_Config &cfg, const std::string &cfg_scope) : 
...
class PMIS_Selector< TemplateConfig<AMGX_host, t_vecPrec, t_matPrec, t_indPrec> > : public PMIS_SelectorBase< TemplateConfig<AMGX_host, t_vecPrec, t_matPrec, t_indPrec> >
{
    ...
    public:
        PMIS_Selector(AMG_Config &cfg, const std::string &cfg_scope) : 
          PMIS_SelectorBase<TConfig_h>(cfg, cfg_scope) {}
    private:
...
template <AMGX_VecPrecision t_vecPrec, AMGX_MatPrecision t_matPrec, AMGX_IndPrecision t_indPrec>
class PMIS_Selector< TemplateConfig<AMGX_device, t_vecPrec, t_matPrec, t_indPrec> >: public PMIS_SelectorBase< TemplateConfig<AMGX_device, t_vecPrec, t_matPrec, t_indPrec> >
{
    ...
    public:
        PMIS_Selector(AMG_Config &cfg, const std::string &cfg_scope) : 
          PMIS_SelectorBase<TConfig_d>(cfg, cfg_scope) {}
    private:
...
template<class T_Config>
class PMIS_SelectorFactory : public SelectorFactory<T_Config>
{
    public:
        Selector<T_Config> *create(AMG_Config &cfg, const std::string &cfg_scope) 
        { 
          return new PMIS_Selector<T_Config>(cfg, cfg_scope); 
        }
};
